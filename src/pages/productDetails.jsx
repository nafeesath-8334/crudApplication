        ...
        <div className=" mx-3 my-2 p-3">
            <div className="grid grid-cols-2  ">
                <div className="relative w-62 h-60 p-2" >
                    <Carousel>
                        {adds.image.map((item,index) => (<Carousel.Item>
                ...
                <div className="text-2xl font-bold text-green-600 mt-4  border border-2 bg-slate-100 px-3 py-5">
                    <p className="text-gray-500 mt-2">{adds?.description}</p>
                    <span>Price: {adds?.price}</span>
                </div>
                <div className="  bg-slate-100">
                    <h1 className="text-2xl font-bold text-gray-800">{adds?.title}</h1>
                    <p className="text-gray-500 mt-2">{adds?.description}</p>
